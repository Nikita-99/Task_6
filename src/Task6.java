...
class Task6 {
    public static void main(String[] args) {
        System.out.println(Zad1.bell(3));
        System.out.println(Zad2.translateWord("flag"));
        System.out.println(Zad2.translateSentence("I like to eat honey waffles."));
        System.out.println(Zad3.validColor("(0,,0)"));
        System.out.println(Zad4.stripUrlParams("https://edabit.com?a=1&b=2&a=2"));
        System.out.println(Zad5.getHashTags("How the Avocado Became the Fruit of the Global Trade"));
        System.out.println(Zad6.ulam(9));
        System.out.println(Zad7.longestNonrepeatingSubstring("abcabcbb"));
        System.out.println(Zad8.convertToRoman(16));
        System.out.println(Zad9.formula("6 * 4 = 24"));
        System.out.println(Zad10.palindromedescendant("11211230"));
    }
}
